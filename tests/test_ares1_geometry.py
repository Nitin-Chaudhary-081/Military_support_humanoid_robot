...
def test_ares1_xacro_and_mass_budget():
    ...
    # drone bays per arc.md 459
    assert root.find(".//link[@name='drone_fixed_wing']") is not None
    assert root.find(".//link[@name='drone_quad']") is not None
